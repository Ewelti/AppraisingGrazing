...
################
tiff(filename = "plots/SoilChem_individualPlots.tiff", width = 9, height = 5, units = 'in', res = 600, compression = 'lzw')
...
#########################################################
##Soil P
plot(1, type="n", xlim=c(5.5,9.5), ylim=c(0,32),las=1,ylab="",xlab="", xaxt='n')
axis(1, at=c(6,7,8,9),cex.axis=1,labels=c("Jun","Jul","Aug","Sept"))
box(lwd=2)
...
##Soil K
plot(1, type="n", xlim=c(5.5,9.5), ylim=c(100,400),las=1,ylab="",xlab="", xaxt='n')
axis(1, at=c(6,7,8,9),cex.axis=1,labels=c("Jun","Jul","Aug","Sept"))
box(lwd=2)
...
##Soil Mg
plot(1, type="n", xlim=c(5.5,9.5), ylim=c(150,500),las=1,ylab="",xlab="", xaxt='n')
axis(1, at=c(6,7,8,9),cex.axis=1,labels=c("Jun","Jul","Aug","Sept"))
box(lwd=2)
...
##Soil Na
plot(1, type="n", xlim=c(5.5,9.5), ylim=c(20,260),las=1,ylab="",xlab="", xaxt='n')
axis(1, at=c(6,7,8,9),cex.axis=1,labels=c("Jun","Jul","Aug","Sept"))
box(lwd=2)
